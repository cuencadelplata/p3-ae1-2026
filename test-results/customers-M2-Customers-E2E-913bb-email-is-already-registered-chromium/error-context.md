...
- Name: customers.spec.ts >> M2 Customers E2E >> RF-2.1 - Customer profile >> shows 409 error when email is already registered
- Location: tests/e2e/customers.spec.ts:55:9
