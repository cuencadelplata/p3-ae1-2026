...
- Name: customers.spec.ts >> M2 Customers E2E >> Navigation >> shows not found state for unknown customer id
- Location: tests/e2e/customers.spec.ts:161:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5173/customers/cust_nonexistent000
Call log:
  - navigating to "http://localhost:5173/customers/cust_nonexistent000", waiting until "load"
